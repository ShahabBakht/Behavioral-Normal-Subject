...
% Claire data
% Uthreshold_L = ?; Lthreshold_L = ?;
% load('D:\Analysis\Behavioral-Normal-Subject\Raw Eye\ClaireData.mat');
% load('D:\Analysis\Behavioral-Normal-Subject\Saccades\ClaireSaccades.mat');
% X = cat(2, ...
%     X16042908(:,:,1:1804), ...
%     X16050201(:,:,1:1804), ...
%     X16050202(:,:,1:1804), ...
...
% load('D:\Analysis\Behavioral-Normal-Subject\Raw Eye\LucyData.mat');
% load('D:\Analysis\Behavioral-Normal-Subject\Saccades\LucySaccades.mat');
% X = cat(2, ...
%     X16031608(:,:,1:1805), ...
%     X16032101(:,:,1:1805), ...
%     X16032102(:,:,1:1805), ...
...
% 
% Helga data
% load('D:\Analysis\Behavioral-Normal-Subject\Raw Eye\HelgaData.mat');
% load('D:\Analysis\Behavioral-Normal-Subject\Saccades\HelgaSaccades.mat');
% X = cat(2, ...
%     X16031104(:,:,1:1807), ...
%     X16031705(:,:,1:1807), ...
%     X16031706(:,:,1:1807), ...
...
% load('D:\Analysis\Behavioral-Normal-Subject\Raw Eye\MelissaData.mat');
% load('D:\Analysis\Behavioral-Normal-Subject\Saccades\MelissaSaccades.mat');
% X = cat(2, ...
%     X16031408(:,:,1:1808), ...
%     X16031707(:,:,1:1808), ...
%     X16031708(:,:,1:1808), ...
...
% load('D:\Analysis\Behavioral-Normal-Subject\Raw Eye\GabrielData.mat');
% X = cat(2, ...
%     X2501(:,:,1:1806), ...
%     X2502(:,:,1:1806), ...
%     X2601(:,:,1:1806), ...
...
% 
% Azar data
% load('D:\Analysis\Behavioral-Normal-Subject\Raw Eye\AzarData.mat');
% X = cat(2 ...
%     ,X1601(:,:,1:1806) ...
%     ,X1602(:,:,1:1806) ...
%     ,X1701(:,:,1:1806) ...
...
% Shahab data
load('D:\Analysis\Behavioral-Normal-Subject\Raw Eye\ShahabData.mat');
X = cat(2 ...
    ,X1801(:,:,1:1805) ...
    ,X1802(:,:,1:1805) ...
    ,X1803(:,:,1:1805) ...
...
scatterhist(TV_L,SVC_L,'Group',Cond,'LineStyle',{'-'},'Marker','.','MarkerSize',20);
...
%%
figure;plot([2,6,20],c_tc,'r-','LineWidth',2);hold on;plot([2,6,20],rlo_tc,'r--','LineWidth',0.5);plot([2,6,20],rup_tc,'r--','LineWidth',0.5);ylim([0,0.5])
hold on
plot([2,6,20],c_vs,'b-','LineWidth',2);hold on;plot([2,6,20],rlo_vs,'b--','LineWidth',0.5);plot([2,6,20],rup_vs,'b--','LineWidth',0.5);ylim([0,0.5])
plot([2,6,20],c_cs,'k-','LineWidth',2);hold on;plot([2,6,20],rlo_cs,'k--','LineWidth',0.5);plot([2,6,20],rup_cs,'k--','LineWidth',0.5);ylim([0,0.5])
plot([2,6,20],c_ls,'g-','LineWidth',2);hold on;plot([2,6,20],rlo_ls,'g--','LineWidth',0.5);plot([2,6,20],rup_ls,'g--','LineWidth',0.5);ylim([0,0.5])
plot([2,6,20],c_hr,'c-','LineWidth',2);hold on;plot([2,6,20],rlo_hr,'c--','LineWidth',0.5);plot([2,6,20],rup_hr,'c--','LineWidth',0.5);ylim([0,0.5])
plot([2,6,20],c_mp,'m-','LineWidth',2);hold on;plot([2,6,20],rlo_mp,'m--','LineWidth',0.5);plot([2,6,20],rup_mp,'m--','LineWidth',0.5);ylim([0,0.5])
plot([2,6,20],c_ag,'k-','LineWidth',2);hold on;plot([2,6,20],rlo_ag,'k--','LineWidth',0.5);plot([2,6,20],rup_ag,'k--','LineWidth',0.5);ylim([0,0.5])
plot([2,6,20],c_gc,'b-','LineWidth',2);hold on;plot([2,6,20],rlo_gc,'b--','LineWidth',0.5);plot([2,6,20],rup_gc,'b--','LineWidth',0.5);ylim([0,0.5])
plot([2,6,20],c_az,'r-','LineWidth',2);hold on;plot([2,6,20],rlo_az,'r--','LineWidth',0.5);plot([2,6,20],rup_az,'r--','LineWidth',0.5);ylim([0,0.5])
plot([2,6,20],c_sb,'g-','LineWidth',2);hold on;plot([2,6,20],rlo_sb,'g--','LineWidth',0.5);plot([2,6,20],rup_sb,'g--','LineWidth',0.5);ylim([0,0.5])
